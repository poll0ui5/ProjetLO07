...
<body>
    <div class="container mt-4">
        ...
        <h3 class="mb-4">Sélectionnez un projet pour afficher son planning</h3>

        <?php if (isset($_GET['error'])): ?>
            <div class="alert alert-danger">Veuillez choisir un projet.</div>
        <?php endif; ?>

        <form method="post" action="router1.php?action=projetPlanning&planning=1" class="card p-4 shadow-sm">
            <div class="mb-3">
